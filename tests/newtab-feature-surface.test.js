...
assert.match(app, /function mutateSidebar\(mutator, done\)[\s\S]*?chrome\.storage\.local\.get\(KEY/);
...
assert.match(content, /function mutateSidebar\(mutator, done\)[\s\S]*?chrome\.storage\.local\.get\(KEY/);
